...
%This section explains the different AI controllers used in testing games in the VGDL language, and the two different approaches to generating game descriptions: Mutating existing games-, and randomly generating descriptions.
%
%
