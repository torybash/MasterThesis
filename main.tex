...
After my addition of VGDL game descriptions to GVG-AI framework there is a total 33 human designed games which could potentially be used as a base-line for quality in games. 
...
Of the more difficult game-level pairs, two requiring 50 or more actions for the shortest solution, and eight pairs requiring more than 35 moves.
The Figure \ref{fig:evol_puzzle_genlvls} shows the levels of the two of the more interesting game-level pairs (\texttt{evol_puzzle015} and \textit{evol_puzzle009}), and Figure \ref{fig:evol_puzzle_desc} the game description of the most difficult.
...
The generator is able to generate levels for most designed VGDL games, and certain generated games, restricted to a subset of classes, that -- at least -- have non-trivial solutions which are not immediately obvious, even with the tight restrictions of the level size (6x6 playing field).
...
\item [(Real) Soko-Ban] \citep{game:Soko-Ban} The original push-boxes games. 
