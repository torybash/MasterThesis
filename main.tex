...
As mentioned in Section \ref{sec_discussionofinitialtest} only the \textit{score} and \textit{win-rate} seems to have different distributions on the type of game, and therefore those values are probably more useful to inspect for an evaluation function.
...
About statistics, we could use an series of different values simply to compare the score: \textit{minimum}- and \textit{maximum} score, \textit{standard deviation} of score, \textit{median}, \textit{quartiles} or any form of normalised score. 
