...
The games are all focused on a increasing the players score.
...
Additionally these games are constructed using only a subset of the VGDL classes- and functions defined in the GVG-AI framework (see Section \ref{sec_gvgaiframework}).
...
wwwwwwww    wwwwwwww    wwwwwwww
\end{vgdldesc}
\caption{The evolution of a randomly generated level for the game Bait. The three levels are the best in the population at generation 1 (requires 7 moves), generation 30 (requires 35 moves} and generation 100 (requires 57 moves), respectively.
