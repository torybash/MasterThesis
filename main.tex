...
Procedural generation of game content has become a widely used tool for video-game developers.
Automatically generating content allow game developers to provide more content, with more differentation, from a limited supply of assets, most often by helping to produce levels or items for their games. 
Rogue \citeyearpar{game:rogue} is one of the earliest examples on proceduraly generating game levels (or dungeons). Several highly popular games has since used procedurally generated levels, some as a main part of their game-play (Civilazation II-V \citeyearpar{game:civilizationseries}, the Diablo-series \citeyearpar{game:diabloseries} 


Procedural content generation (PCG) for games has been a main part of commercial video games for decades, 
...
A description of each of the games and their interpretations can be seen in Appendix \ref{app_thesisgame}
